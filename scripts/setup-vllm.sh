...
#   VLLM_VENV=/path/to/sn-47-agent/vllm_env bash scripts/setup-vllm.sh
...
echo -e "       ${CYAN}\${EVOLAI_PYTHON:-../evolai/.venv/bin/python} $AGENT_DIR/validator_kl_eval.py \\${RESET}"
